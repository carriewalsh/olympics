...
describe "As a visitor" do
  describe "when I reach olympians" do
    before :each do
      ...
      @o2 = @team.olympians.create(name: "Name 2", sex: "F", age: 36, weight: 100, height: 150)
      @o3 = @team.olympians.create(name: "Name 3", sex: "M", age: 20, weight: 100, height: 160)
      @o4 = @team.olympians.create(name: "Name 4", sex: "M", age: 30, weight: 120, height: 170)
    ...
    it "returns the oldest athlete with age query" do
      ...
      expect(body[:olympians].first[:name]).to eq("Name 2")
    end

    it "returns the youngest athlete with age query" do
