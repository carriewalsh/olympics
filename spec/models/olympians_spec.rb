  ...
  describe "class methods" do
    ...
    describe "list_olympians" do
      it "should return the olympians and their summary" do
        expect(Olympian.list_olympians[:olympians].count).to eq(4)
        expect(Olympian.list_olympians[:olympians].first[:name]).to eq("Name 1")
        expect(Olympian.list_olympians[:olympians].first[:team]).to eq("USA")
        expect(Olympian.list_olympians[:olympians].first[:age]).to eq(18)
        expect(Olympian.list_olympians[:olympians].first[:sport]).to eq("Taekwondo")
        expect(Olympian.list_olympians[:olympians].first[:total_medals_won]).to eq(2)
      end
    end
  end
